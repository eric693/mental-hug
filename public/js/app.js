...
const App = {
  ...
  navGroups: [
    ...
    { label: '專業與營運', keys: ['supervision', 'hr', 'rampup', 'payouts', 'split-rules', 'settlement', 'billing', 'reconcile', 'finance', 'overdue', 'packages', 'projects', 'rentals', 'partners', 'announcements', 'reports', 'finance-metrics', 'staff-metrics'] },
